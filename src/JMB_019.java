...
public class JMB_019 {
	...
	public static void main(String[] args) throws MalformedURLException
	{
		...
		//check save button is present or not
		try 
		{
		     if(driver.findElement(By.id("com.jombone.jombone:id/btnSaveChanges")).isDisplayed()) 
		     {
		          driver.findElement(By.id("com.jombone.jombone:id/btnSaveChanges")).click();
		     }
		}
		catch (NoSuchElementException e)
		{
		    System.out.println("Save button is not there");
		}
