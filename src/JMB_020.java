...
public class JMB_020 {
	...
	public static void main(String[] args) throws MalformedURLException
	{
		...
		if(driver.findElement(By.id("com.jombone.jombone:id/profileCompleteness"))!= null)
		{
			System.out.println("graphical representation of profile completeness bar is Present");
		}else
		{
			System.out.println("graphical representation of profile completeness bar is Absent");
		}
