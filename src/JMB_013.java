...
public class JMB_013
{
	...
	public static void main(String[] args) throws MalformedURLException
	{
		...
		WebElement searchBox = driver.findElement(By.id("com.jombone.jombone:id/profileAvailable"));
				   if(searchBox.isEnabled()) 
				   { 
				      System.out.println("Candidate is available-shown successfully"); 
				   } 
				   else 
				   { 
