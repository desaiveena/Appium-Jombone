...
public class JMB_011 {
	...
	public static void main(String[] args) throws MalformedURLException
	{
		...
		Boolean Display = driver.findElement(By.id("com.jombone.jombone:id/phoneNumber")).isDisplayed();
		//To print the value
		System.out.println("The phone number is displayed on profile :"+Display);
	}
